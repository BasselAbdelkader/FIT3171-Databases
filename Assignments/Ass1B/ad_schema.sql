...
ALTER TABLE invoice
    ADD CONSTRAINT invoice_pk PRIMARY KEY ( invoice_serv_time,
                                            invoice_serv_date,
                                            vet_id,
                                            pet_id );
...
ALTER TABLE invoice_drugs
    ADD CONSTRAINT invoice_drugs_pk PRIMARY KEY ( invoice_serv_time,
                                                  invoice_serv_date,
                                                  vet_id,
                                                  pet_id,
                                                  drug_id );
...
ALTER TABLE invoice_services
    ADD CONSTRAINT invoice_services_pk PRIMARY KEY ( invoice_serv_time,
                                                     invoice_serv_date,
                                                     vet_id,
                                                     pet_id,
                                                     serv_code );
...
ALTER TABLE pet
    ADD CONSTRAINT chk_pet_status CHECK ( pet_status IN ( 'N', 'Y' ) );
...
ALTER TABLE prescription ADD CONSTRAINT prescription_nk UNIQUE ( visit_date,
                                                                 drug_id );
...
ALTER TABLE invoice_drugs
    ADD CONSTRAINT invoice_drugs_invoice_fk FOREIGN KEY ( invoice_serv_time,
                                                          invoice_serv_date,
                                                          vet_id,
                                                          pet_id )
        REFERENCES invoice ( invoice_serv_time,
                             invoice_serv_date,
                             vet_id,
                             pet_id );

ALTER TABLE invoice_services
    ADD CONSTRAINT invoice_services_invoice_fk FOREIGN KEY ( invoice_serv_time,
                                                             invoice_serv_date,
                                                             vet_id,
                                                             pet_id )
        REFERENCES invoice ( invoice_serv_time,
...
ALTER TABLE invoice
    ADD CONSTRAINT pet_invoices FOREIGN KEY ( pet_id )
        REFERENCES pet ( pet_id );

ALTER TABLE visit
    ADD CONSTRAINT pet_visits FOREIGN KEY ( pet_id )
        REFERENCES pet ( pet_id );
...
ALTER TABLE invoice
    ADD CONSTRAINT vet_invoices FOREIGN KEY ( vet_id )
        REFERENCES vet ( vet_id );
